...
import type { Portafolio } from '@/lib/data';

// Extraído de page.tsx (auditoría 2026-08-15, A3): la interactividad (hover, scroll loop
// infinito) sigue siendo cliente, pero los datos ahora llegan ya resueltos como prop desde el
// Server Component padre (Server Action escopada, lib/data/actions/public.ts) en vez de
// useDataStore().

export function PortafolioListaClient({ proyectos }: { proyectos: Portafolio[] }) {
