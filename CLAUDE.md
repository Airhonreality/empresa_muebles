...
**Pendiente hasta que se confirme el stack** (propuesta: Next.js + TypeScript + Drizzle ORM + Neon Postgres, reutilizando la misma base de datos). El rol QA no puede aprobar tareas de código de producto hasta que esta tabla se complete.
