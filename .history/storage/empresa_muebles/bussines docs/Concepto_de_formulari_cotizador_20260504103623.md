...
header con la metadata del proeycto, cliente, direccion, correo, cedula, etc etc, imgaina metadatos completos...
...
Cada campo de texto debe ser editable, ejemplo "nombre del espacio" "variante" datos de cleinte" allí mismo donde se proyectan debe ser el lugar ideal para editarse, con un doble clic se activa el campo para ser editado... deben haber vistas movil y vista web pc... responsividad total. Colores de estetica de lujo que resuenen con la marca "veta de oro".