...
export const PARAMETROS: Parametro[] = [
  ...
  { id: UUID('par08'), clave: 'transiciones_proyecto', grupo: 'comercial', tipo: 'texto', valorNumeric: null, valorTexto: JSON.stringify({
    ...
    enviada: ['negociacion', 'en_contrato', 'perdida', 'cancelada'],
    negociacion: ['en_contrato', 'enviada', 'perdida', 'cancelada'],
    en_contrato: ['pre_produccion', 'retoma', 'perdida', 'cancelada'],
    retoma: ['en_contrato', 'pre_produccion', 'perdida', 'cancelada'],
    pre_produccion: ['produccion', 'retoma', 'cancelada'],
    produccion: ['entregado', 'retoma', 'cancelada'],
    entregado: ['perdida', 'cancelada'],
    perdida: [],
    cancelada: [],
  }), valorBooleano: null, unidad: null, descripcion: 'Matriz de transiciones válidas del kanban comercial (C3) - Alineado con ACCIONES_POR_ESTADO' },
...
export const PORTAFOLIO: Portafolio[] = [
  { id: UUID('port01'), proyectoId: UUID('proj06'), titulo: 'Cocina compacta en cedro — Díaz', descripcionComercial: 'Cocina pequeña con electrodomésticos integrados y aprovechamiento total del espacio.', categoriaEspacio: 'cocina', espacioVarianteId: null, materialesDestacados: ['Cedro', 'Granito'], precioReferencial: 'desde $8.000.000 COP', imagenPortafolioUrl: '/images/home/cocinas-integrales-diseno-fabricacion-bogota-1.webp', galeriaPortafolioUrl: [], barrio: 'Chicó', tipoProyecto: 'Residencial', publicado: true, destacado: true, orden: 0, slug: 'cocina-compacta-diaz', createdAt: '2026-06-05T09:00:00Z', updatedAt: '2026-06-05T09:00:00Z' },
