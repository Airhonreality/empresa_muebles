...
interface AgnosticRoutePageProps {
  slug: string[];
}

export async function AgnosticRoutePage({ slug }: AgnosticRoutePageProps) {
  ...
  const requiredRole: string | null = routeData.required_role ?? null;
