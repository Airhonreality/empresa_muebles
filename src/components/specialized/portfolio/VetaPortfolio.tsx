        ...
        >
          {filtered.map((entry, index) => {
            ...
            return (
              <section
                key={entry.slug}
                className="snap-start min-h-screen flex flex-col lg:flex-row"
              >
                {/* Gallery side — 65% */}
                <div className="lg:w-[65%] lg:h-screen p-3 lg:p-4 flex flex-col">
                  <SmartImageGrid
                ...
                {/* Info side — 35% */}
                <div className="lg:w-[35%] px-6 py-6 lg:px-8 lg:py-10 lg:h-screen lg:overflow-y-auto flex flex-col justify-center">
